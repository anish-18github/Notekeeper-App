...
const DeleteConfirmModal = function (title) {
    ...
    /**
     * Handle the submission of the delete confirmation.
     * 
     * @param {Function} callback - The callback function to execute with the confirmation result (true for confirmation, 
     * false for cancel)
     */
    const onSubmit = function (callback) {
