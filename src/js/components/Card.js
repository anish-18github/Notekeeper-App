...
export const Card = function (noteData) {
     ...
     * 
     * Attaches a click event listner to card element, 
     ...
     * When the delete button is clicked, it opens a confirmation nodal for deleting the associated note.
     * If the deletion is confirmed, ir updates the UI and database to remove the note.
     */
